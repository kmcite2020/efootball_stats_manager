...
abstract class $PlayerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int goals});
}
...
class _$_Player implements _Player {
  const _$_Player({required this.name, required this.goals});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, goals);
...
abstract class _Player implements Player {
  const factory _Player(
      {required final String name, required final int goals}) = _$_Player;
